...
def main() -> None:
    parser = argparse.ArgumentParser(description="批量提交 GFN2-xTB baseline 标注任务。")
    ...
    parser.add_argument("--no-wait", dest="wait", action="store_false", help="提交后直接返回，不等待结果。")
    ...
    print(f"baseline 任务处理完成，共 {len(jobs)} 个样本。")
