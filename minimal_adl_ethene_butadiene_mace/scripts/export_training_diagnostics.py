...
def main() -> None:
    ...
    main_predictions_path = Path(
        paths_cfg.get("train_main_predictions_file", Path(paths_cfg["models_dir"]) / "train_main_predictions.csv")
    )
    aux_predictions_path = Path(
        paths_cfg.get("train_aux_predictions_file", Path(paths_cfg["models_dir"]) / "train_aux_predictions.csv")
    )
    ...
    diagnostics_path = Path(
        paths_cfg.get("training_diagnostics_file", Path(paths_cfg["models_dir"]) / "training_diagnostics.json")
    )
